...
Revision ID: b35de70f7b02
Revises: 
Create Date: 2025-09-01 12:01:01.159469
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_hourly_heart_rate_id'), 'hourly_heart_rate', ['id'], unique=False)
